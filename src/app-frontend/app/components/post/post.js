	...
	render() {	
		return(
			<div {...this.props.attributes} className={styles.style}>
				...
				{!this.props.embeded && <PostFooter  bio={this.props.bio} authorg={this.props.authorg} submission={this.props.submission} revision={this.props.revision} focusedPost={this.props.focusedPost} submissionValue={this.props.submissionValue} />}
				{this.props.children}
			</div>
		);
	}
