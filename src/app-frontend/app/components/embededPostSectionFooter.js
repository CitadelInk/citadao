...
class EmbededPostSectionFooter extends Component {
	 constructor(props) {
		 super(props);
	...
	render() {
		...
		if(this.props.submission && this.props.submission.revisionReactionReactors) {
...
export default connect(mapStateToProps)(EmbededPostSectionFooter)
