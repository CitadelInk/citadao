  ...
  renderScreen5() {
    return <g>
      {[
        ...
        <Edge key="32" p1={this.props.nodes[37]} p2={this.props.nodes[44]} currentLayer={1}/>,
        <Edge key="33" p1={this.props.nodes[37]} p2={this.props.nodes[50]} currentLayer={1}/>,
        <Edge key="34X" p1={this.props.nodes[37]} p2={this.props.nodes[52]} currentLayer={0}/>,
        <Edge key="35" p1={this.props.nodes[52]} p2={this.props.nodes[66]} currentLayer={1}/>,
        <Edge key="36" p1={this.props.nodes[52]} p2={this.props.nodes[72]} currentLayer={1}/>,
        <Edge key="37" p1={this.props.nodes[52]} p2={this.props.nodes[63]} currentLayer={1}/>,
      ]}
    </g>;
  }
  render() {
